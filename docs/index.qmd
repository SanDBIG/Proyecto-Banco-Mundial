...
Como este archivo `index.qmd` se encuentra dentro de la carpeta `docs/`, las rutas usadas en el código suben un nivel hacia la raíz del proyecto mediante `../`.
...
<https://dbigggg.shinyapps.io/proyecto-banco-mundial-dashboard/>
...
<https://github.com/SanDBIG/Proyecto-Banco-Mundial>